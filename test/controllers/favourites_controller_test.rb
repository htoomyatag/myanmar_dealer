...
class FavouritesControllerTest < ActionController::TestCase
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post :create, favourite: { item: @favourite.item, item_code: @favourite.item_code, user_id: @favourite.user_id }
    end
  ...
  test "should update favourite" do
    patch :update, id: @favourite, favourite: { item: @favourite.item, item_code: @favourite.item_code, user_id: @favourite.user_id }
    assert_redirected_to favourite_path(assigns(:favourite))
  end
