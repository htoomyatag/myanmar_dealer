class SportsController < ApplicationController
  ...
  private
    ...
    def sport_params
      params.require(:sport).permit(:store_name,:user_id,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :price, :quantity, :weight, :made_by_country, :made_with, :description, :color, :brand, :category)
    end
