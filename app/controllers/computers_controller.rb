class ComputersController < ApplicationController
  ...
  private
    ...
    def computer_params
      params.require(:computer).permit(:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :price, :quantity, :size, :weight, :Thickness, :made_by_country, :description, :brand, :category, :modal_number, :color, :feature, :operation_system)
    end
end
