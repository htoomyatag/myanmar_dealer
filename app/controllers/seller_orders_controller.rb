class SellerOrdersController < ApplicationController
  ...
  private
    ...
    def seller_order_params
      params.require(:seller_order).permit(:seller_id, :order_status,:buyer_id,:cart_id, :customer_name, :customer_email, :customer_phone, :customer_city, :customer_township, :customer_address)
    end
end
