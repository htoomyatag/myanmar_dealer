class BathSuppliesController < ApplicationController
  ...
  private
    ...
    def bath_supply_params
      params.require(:bath_supply).permit(:quantity,:store_name,:seller_id,:price,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :category, :ingredient, :usage, :made_by_country, :description, :brand, :effect, :certification, :age_group)
    end
