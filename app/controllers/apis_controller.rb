class ApisController < ApplicationController
  ...
  def my_api_sports
    ...
    @specifications = Product.select(:id,:weight, :made_by_country, :made_with, :color, :brand).where(:category => "sports")
  ...
  def my_api_gifts
    ...
    @specifications = Product.select(:id,:weight, :made_by_country, :made_with, :description, :color).where(:category => "gifts")
  ...
  def my_api_car_accessories
    ...
    @specifications = Product.select(:id,:size, :weight, :made_by_country, :made_with, :brand, :specification, :modal_number, :color, :feature).where(:category => "car_accessories")
  ...
  def my_api_machines
    ...
    @specifications = Product.select(:id,:dimension, :weight, :made_by_country, :made_with, :description, :brand, :category, :modal_number, :specification, :color).where(:category => "machines")
  ...
  def my_api_instruments
    ...
    @specifications = Product.select(:id,:dimension, :weight, :made_by_country, :made_with, :description, :brand, :modal_number, :specification, :color).where(:category => "instruments")
  ...
  @specifications = Product.select(:id, :size, :weight, :made_by_country, :made_with, :description, :brand, :specification, :modal_number, :color).where(:category => "equipments")
  ...
  def my_api_bath_supplies
    ...
    @specifications = Product.select(:id,:ingredient, :usage, :made_by_country, :description, :brand, :effect, :certification, :age_group).where(:category => "bath_supplies")
  ...
  def my_api_beauty_equipments
    ...
    @specifications = Product.select(:id,:brand, :made_by_country, :feature, :modal_number, :color).where(:category => "beauty_equipments")
  ...
  def my_api_medicines
    ...
    @specifications = Product.select(:id,:certification, :ingredient, :usage, :made_by_country, :caution).where(:category => "medicines")
  ...
  def my_api_home_appliances
    ...
    @home_appliances = Product.where(:category => "home_appliance").select(:id,:title,:price,:store_name, :price, :quantity, :avatar1_file_name, :avatar2_file_name, :avatar3_file_name, :avatar4_file_name)
      @specifications = Product.select(:id,:modal_number, :color, :feature, :power, :voltage,:size, :weight, :made_by_country).where(:category => "home_appliance")
  ...
  def my_api_computers
   ...
   @specifications = Product.select(:id,:size,:weight,:thickness,:made_by_country,:brand,:color,:feature,:modal_number,:operation_system ).where(:category => "computers_laptops")
  ...
  def my_api_telephone_accessories
   ...
   @specifications = Product.select(:id,:size,:weight,:feature,:color,:modal_number,:brand).where(:category => "phone_related")
  ...
  def my_api_fashion_hats
    ...
    @fashion_hats = Product.where(:category => "hats").select(:id,:title,:price,:store_name, :price, :quantity, :avatar1_file_name, :avatar2_file_name, :avatar3_file_name, :avatar4_file_name)
      @specifications = Product.select(:id,:made_by_country,:made_with,:hat_type,:brand).where(:category => "hats")
  ...
  def my_api_fashion_footwears
    ...
    @specifications = Product.select(:id,:made_by_country,:made_with,:footwear_type,:size,:brand,:color  ).where(:category => "footwears")
  ...
  def my_api_fashion_bags
    ...
    @fashion_bags = Product.where(:category => "bags").select(:id,:title,:price,:store_name, :price, :quantity, :avatar1_file_name, :avatar2_file_name, :avatar3_file_name, :avatar4_file_name)
     @specifications = Product.select(:id,:made_by_country,:made_with,:bag_type,:size,:brand,:color ).where(:category => "bags")
  ...
  def my_api_fashion_accessories
    ...
    @fashion_accessories = Product.where(:category => "fashion_related").select(:id,:title,:price,:store_name, :price, :quantity, :avatar1_file_name, :avatar2_file_name, :avatar3_file_name, :avatar4_file_name)
       @specifications = Product.select(:id,:made_by_country,:made_with,:brand).where(:category => "fashion_related")
  ...
  def my_api_fashion_clothings
    ...
    @specifications = Product.select(:id,:size,:made_by_country,:made_with,:gender,:brand,:color).where(:category => "cloths")
