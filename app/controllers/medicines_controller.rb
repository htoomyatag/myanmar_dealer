class MedicinesController < ApplicationController
  ...
  private
    ...
    def medicine_params
      params.require(:medicine).permit(:quantity,:store_name,:user_id,:price,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :category, :certification, :ingredient, :usage, :made_by_country, :description, :caution)
    end
