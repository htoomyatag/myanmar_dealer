class MedicinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @medicine.save
        format.html { redirect_to my_products_path, notice: 'Medicine was successfully created.' }
  ...
  private
    ...
    def medicine_params
      params.require(:medicine).permit(:avatar1_edit,:avatar2_edit,:avatar3_edit,:avatar4_edit,:quantity,:store_name,:user_id,:price,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :category, :certification, :ingredient, :usage, :made_by_country, :description, :caution)
    end
