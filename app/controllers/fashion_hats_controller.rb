class FashionHatsController < ApplicationController
  ...
  private
    ...
    def fashion_hat_params
      params.require(:fashion_hat).permit(:delivery_category,:avatar1_edit,:avatar2_edit,:avatar3_edit,:avatar4_edit,:category,:store_name,:user_id,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :price, :quantity, :made_by_country, :made_with, :description, :brand, :hat_type)
    end
