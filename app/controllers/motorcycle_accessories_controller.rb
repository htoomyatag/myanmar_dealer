class MotorcycleAccessoriesController < ApplicationController
  ...
  private
    ...
    def motorcycle_accessory_params
      params.require(:motorcycle_accessory).permit(:category,:store_name,:user_id,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :price, :quantity, :size, :weight, :made_by_country, :made_with, :description, :brand, :specification, :modal_number, :color, :feature)
    end
