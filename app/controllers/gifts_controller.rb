class GiftsController < ApplicationController
  ...
  private
    ...
    def gift_params
      params.require(:gift).permit(:avatar1_edit,:avatar2_edit,:avatar3_edit,:avatar4_edit,:category,:store_name,:user_id,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :price, :quantity, :weight, :made_by_country, :made_with, :description, :color)
    end
