class GiftsController < ApplicationController
  ...
  private
    ...
    def gift_params
      params.require(:gift).permit(:category,:store_name,:seller_id,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :price, :quantity, :weight, :made_by_country, :made_with, :description, :color)
    end
