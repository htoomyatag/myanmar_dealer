class FashionBagsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fashion_bag.save
        format.html { redirect_to @fashion_bag, notice: 'Fashion bag was successfully created.' }
  ...
  private
    ...
    def fashion_bag_params
      params.require(:fashion_bag).permit(:category,:store_name,:seller_id,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :price, :quantity, :made_by_country, :made_with, :description, :bag_type, :size, :brand)
    end
