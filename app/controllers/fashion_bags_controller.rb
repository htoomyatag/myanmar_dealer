class FashionBagsController < ApplicationController
  ...
  private
    ...
    def fashion_bag_params
      params.require(:fashion_bag).permit(:avatar1_edit,:avatar2_edit,:avatar3_edit,:avatar4_edit,:color,:category,:store_name,:user_id,:avatar1,:avatar2,:avatar3,:avatar4,:avatar5,:title, :price, :quantity, :made_by_country, :made_with, :description, :bag_type, :size, :brand)
    end
